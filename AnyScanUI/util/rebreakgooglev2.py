...
# GECKODRIVER_BIN = r"C:\M1a0\Python27\geckodriver.exe"
#
...
#                 '//div[@class="recaptcha-checkbox-checkmark" and @role="presentation"]').click()
...
#             print("[{0}] Could not request results from Google Speech Recognition service; {1}".format(
#                 self.current_iteration).format(e))
#
#         return audio_output
#
